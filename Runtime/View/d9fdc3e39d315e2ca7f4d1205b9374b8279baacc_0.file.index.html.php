<?php
/* Smarty version 3.1.32-dev-38, created on 2017-11-24 17:47:01
  from 'D:\web\mycore\Application\View\Admin\index.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32-dev-38',
  'unifunc' => 'content_5a17ea95388923_62175965',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'd9fdc3e39d315e2ca7f4d1205b9374b8279baacc' => 
    array (
      0 => 'D:\\web\\mycore\\Application\\View\\Admin\\index.html',
      1 => 1511516818,
      2 => 'file',
    ),
  ),
...
function content_5a17ea95388923_62175965 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_subTemplateRender('file:Admin/Public/header.html', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
    ...
    <div class="tpl-left-nav tpl-left-nav-hover">
        ...
        <div class="tpl-left-nav-list">
            <ul class="tpl-left-nav-menu">
                ...
                <li class="tpl-left-nav-item">
                    <a class="nav-link tpl-left-nav-link-list" href="chart.html">
                        <i class="am-icon-bar-chart">
                        </i>
                        <span>
                            数据表
                        </span>
                ...
                <li class="tpl-left-nav-item">
                    <a class="nav-link tpl-left-nav-link-list" href="javascript:;">
                        <i class="am-icon-wpforms">
                        </i>
                        <span>
                            表单
                        </span>
                        <i class="am-icon-angle-right tpl-left-nav-more-ico am-fr am-margin-right tpl-left-nav-more-ico-rotate">
                        </i>
                    </a>
                ...
                <li class="tpl-left-nav-item">
                    <a class="nav-link tpl-left-nav-link-list" href="login.html">
                        <i class="am-icon-key">
                        </i>
                        <span>
                            登录
                ...
                <div class="tpl-portlet">
                    <div class="tpl-portlet-title">
                        <div class="tpl-caption font-green ">
                            <i class="am-icon-cloud-download">
                            </i>
                            <span>
                                Cloud 数据统计
                            </span>
                    ...
                    <div class="tpl-scrollable">
                        ...
                        <table class="am-table tpl-table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <img alt="" class="user-pic" src="assets/img/user01.png">
                                ...
                                <tr>
                                    <td>
                                        <img alt="" class="user-pic" src="assets/img/user02.png">
                                        <a class="user-name" href="###">
                                            Alex.
                                        </a>
                                        </img>
                                ...
                                <tr>
                                    <td>
                                        <img alt="" class="user-pic" src="assets/img/user03.png">
                                        <a class="user-name" href="###">
                                            Tinker404
                                        </a>
                                        </img>
                                ...
                                <tr>
                                    <td>
                                        <img alt="" class="user-pic" src="assets/img/user04.png">
                                        <a class="user-name" href="###">
                                            Arron.y
                                        </a>
                                        </img>
                                ...
                                <tr>
                                    <td>
                                        <img alt="" class="user-pic" src="assets/img/user05.png">
                                        <a class="user-name" href="###">
                                            Yves
                                        </a>
                                        </img>
                                ...
                                <tr>
                                    <td>
                                        <img alt="" class="user-pic" src="assets/img/user06.png">
                                        <a class="user-name" href="###">
                                            小黄鸡
                                        </a>
                                        </img>
                        ...
                        <div class="tpl-portlet-input">
                            <div class="portlet-input input-small input-inline">
                                <div class="input-icon right">
                                    <i class="am-icon-search">
                                    </i>
                                    <input class="form-control form-control-solid" placeholder="搜索..." type="text">
                                    </input>
                                </div>
                            </div>
                        </div>
                            ...
                            <ul class="tpl-task-list">
                                <li>
                                    <div class="task-checkbox">
                                        ...
                                        <input class="liChild" name="test" type="checkbox" value="2">
                                        </input>
                                        </input>
                                    </div>
                                    <div class="task-title">
                                        ...
                                        <span class="task-bell">
                                            <i class="am-icon-bell-o">
                                            </i>
                                        </span>
                                    </div>
                                    <div class="task-config">
                                        <div class="am-dropdown tpl-task-list-dropdown" data-am-dropdown="">
                                            <a class="am-dropdown-toggle tpl-task-list-hover " data-am-dropdown-toggle="" href="###">
                                                <i class="am-icon-cog">
                                                </i>
